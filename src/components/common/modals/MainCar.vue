...
const { carrinho, removerCarrinho, alterarEstoque, formatCurrency } = useProduct()
...
function calcularTotal() {
  return (carrinho.value || []).reduce((total, produto) => {
...
<template>
  <div v-if="props.carrinhoAberto" class="carrinho">
    ...
    <div v-if="carrinho.length === 0" class="produtos">
      <p>Carrinho vazio</p>
    </div>

    <div v-else>
      <div v-for="produto in carrinho" :key="produto.id" class="produtos">
          ...
          <div class="acoes">
            ...
            <div class="buttons-acao">
              ...
              <div class="qtd-acoes">
                ...
                <button class="add" @click="alterarEstoque(produto.id, +1)">+</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="footer-carrinho">
      <div class="total">
        <p>Total:</p>
        <p>{{ formatCurrency(calcularTotal()) }}</p>
      </div>
      <div class="btn">
